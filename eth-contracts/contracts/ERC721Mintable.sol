...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Provide a valid address.");
        _owner = newOwner;
    }
}
...
contract Pausable is Ownable {
    ...
    function changePause(bool pause) public onlyOwner {
        require(pause != _paused, "Contract mode does not change.");
        _paused = pause;
    ...
    modifier whenNotPaused() {
        require(!_paused, "You can not call this function while contract is paused.");
        _;
    }

    modifier whenPaused() {
        require(_paused, "You can not call this function while contract is not paused.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "Token already belongs to this address.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((msg.sender == tokenOwner) || isApprovedForAll(tokenOwner, msg.sender), "Address must be the owner or an approved address.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Token does not belong to the given address.");
...
contract CustomERC721Token is ERC721Metadata("Marioken", "MKN", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
